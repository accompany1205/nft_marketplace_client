                    ...
                    <div className="col-md-3 col-sm-6 col-xs-1">
                        <div className="widget">
                            ...
                            <ul>
                                ...
                                <li><Link href="">Virtual World</Link></li>
                      ...
                      <div className="col-md-3 col-sm-6 col-xs-1">
                          <div className="widget">
                              ...
                              <ul>
                                  ...
                                  <li><Link href="">Suggestions</Link></li>
                      ...
                      <div className="col-md-3 col-sm-6 col-xs-1">
                          <div className="widget">
                              ...
                              <ul>
                                  ...
                                  <li><Link href="">Mailing List</Link></li>
                              </ul>
                        </div>
                    </div>
                    <div className="col-md-3 col-sm-6 col-xs-1">
                        <div className="widget">
                            <h5>Newsletter</h5>
                            <p>Signup for our newsletter href get the latest news in your inbox.</p>
